              ...
              {[
                {
                  name: 'S.K様（42歳）',
                  company: 'パーソナルジム経営',
                  testimonial: '正直、最初は半信半疑でした。でも実際に使ってみて、目から鱗が落ちる思いでしたね。例えば、無料体験をどうするか悩んでいた時のことです。閑散期だけでも無料体験を出そうかと考えていたんですが、社長のミギウデに相談したところ、「無料体験で集客するより、この時期だからこそできる既存会員様への○○施策の方が効果的」という具体的なアドバイスをもらえました。税務の相談にも使えるのが意外な発見でした。'
                },
                {
                  name: 'T.M様（45歳）',
                  company: 'オフィス用品販売会社経営',
                  testimonial: '経営者の時間の使い方が、導入前と後では180度変わりました。特に営業部門からの相談が激減しましたね。「お客様からこう言われたけどどうしましょう」「この程度の値引きは認めていいですか」など、似たようなケースの判断依頼が本当に多かったんです。導入してからは、そういった判断の8割くらいは社長のミギウデが対応してくれます。しかも、私の経営方針に沿った回答をしてくれるので安心です。'
                },
                {
                  name: 'K.Y様（34歳）',
                  company: '美容クリニック経営',
                  testimonial: '経営者として難しい判断を迫られた時、本当に心強い存在でした。例えば、売上は作れるけれど問題のある行動が続くカウンセラーの処遇について悩んでいた時のことです。社長のミギウデは過去の類似ケースや経営理念を踏まえた上で、「改善するよう指導した上で改善が見られない場合は退職勧奨も検討すべき」という明確な判断基準を示してくれました。分かっていた回答ではありますが、自分の価値観を合った説明をされると腑に落ちた意思決定ができました。'
                }
              ].map((item, index) => (
