            ...
            <div className="space-y-8">
              {[
                ...
                },
                {
                  name: 'K.Y様（34歳）',
                  company: '美容クリニック経営',
                  testimonial: '経営者として難しい判断を迫られた時、本当に心強い存在でした。例えば、売上は作れるけれど問題のある行動が続くカウンセラーの処遇について悩んでいた時のことです。MindCloneは過去の類似ケースや経営理念を踏まえた上で、『改善��機会を与えた上で���なお改善が見られない場合は退職勧奨も検討すべき』という明確な判断基準を示してくれました。経営者として、時には耳の痛い指摘もしてくれますが、それも含めて信頼できる相談相手だと感じています。'
                }
              ].map((item, index) => (
